...
def get_args_parser():
    parser = argparse.ArgumentParser('PiX script', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='PiXResNet50_cs', type=str, metavar='MODEL',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('PiX script', parents=[get_args_parser()])
