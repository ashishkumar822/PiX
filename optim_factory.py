...
def get_num_layer_for_pixnet(num_max_layer, var_name):
    if var_name.find("stem") != -1:
        return 0
    elif var_name.find("layer") != -1:
...
class LayerDecayValueAssigner(object):
    ...
    def get_layer_id(self, var_name):
        return get_num_layer_for_pixnet(self.num_max_layer, var_name)
